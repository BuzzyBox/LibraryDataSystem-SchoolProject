...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_edit_memeber_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_edit_memeber_t qt_meta_stringdata_edit_memeber = {
    {
QT_MOC_LITERAL(0, 12) // "edit_memeber"
...
const QMetaObject edit_memeber::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_edit_memeber.offsetsAndSize,
    qt_meta_data_edit_memeber,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_edit_memeber_t
, QtPrivate::TypeAndForceComplete<edit_memeber, std::true_type>
