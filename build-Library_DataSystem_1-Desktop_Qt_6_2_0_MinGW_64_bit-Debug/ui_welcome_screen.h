...
"letter-spacing: -0.408px;"));
    ...
    {
        welcome_screen->setWindowTitle(QCoreApplication::translate("welcome_screen", "Dialog", nullptr));
        lbAboutUs->setText(QCoreApplication::translate("welcome_screen", "About Us!\n"
"\n"
" Lorem ipsum dolr sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore at dolore magne aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo cnsequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.", nullptr));
        lbWelcometoBookNook->setText(QCoreApplication::translate("welcome_screen", "Welcome to BookNook!", nullptr));
        lbBorderSearch->setText(QString());
        lEditSearchBook1->setText(QCoreApplication::translate("welcome_screen", "Search Books", nullptr));
        pushButton->setText(QCoreApplication::translate("welcome_screen", "Sign-Up", nullptr));
        BtnLogin->setText(QCoreApplication::translate("welcome_screen", "Login", nullptr));
    } // retranslateUi
